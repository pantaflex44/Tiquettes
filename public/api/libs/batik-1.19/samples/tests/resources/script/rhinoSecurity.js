...
var basePermissions = [
	...
	[
		"PropertyPermission java.home write",
	...
	[
		...
		new RuntimePermission("loadLibrary.{library name}"),
	],
	[
	...
	[
		...
		new SerializablePermission("getDomainCombiner"),
	],
	...
	[
		...
		new SerializablePermission("setSystemScope"),
	],
	[
		"SecurityPermission setIdentityPublicKey",
		new SerializablePermission("setIdentityPublicKey"),
	],
	[
		"SecurityPermission setIdentityInfo",
		new SerializablePermission("setIdentityInfo"),
	],
	[
		"SecurityPermission addIdentityCertificate",
		new SerializablePermission("addIdentityCertificate"),
	],
	[
		"SecurityPermission removeIdentityCertificate",
		new SerializablePermission("removeIdentityCertificate"),
	],
	[
		"SecurityPermission printIdentity",
		new SerializablePermission("printIdentity"),
	],
	[
		"SecurityPermission getSignerPrivateKey",
		new SerializablePermission("getSignerPrivateKey"),
	],
	[
		"SecurityPermission setSignerKeyPair",
		new SerializablePermission("setSignerKeyPair"),
	],
	[
...
function init() {
	...
	if (docURL != null && docURL.getHost() != null && !("" == docURL.getHost())) {
		permissions = [];
		...
		permissions[0] = [
			"SocketPermission accept " + docHost,
			new SocketPermission(docHost, "accept"),
		];
		permissions[1] = [
			"SocketPermission connect " + docHost,
			new SocketPermission(docHost, "connect"),
		];
		permissions[2] = [
			"SocketPermission resolve " + docHost,
...
function runEcmascriptSecurityTest() {
	...
	var successRatioString =
		"Test Result: " + successCnt + " / " + statusRects.length;
	var successRatio = document.getElementById("successRatio");
	successRatio.replaceChild(
		document.createTextNode(successRatioString),
