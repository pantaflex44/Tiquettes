			...
			<div className="tabPageBand notprintable">
				...
				<div className="tabPageBandGroup">
					...
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnRowChoice"
							id="summaryColumnRowChoice"
							checked={switchboard.summaryColumnRow}
							onChange={(e) =>
								setSwitchboard((old) => ({
									...old,
						...
						/>
						<label htmlFor="summaryColumnRowChoice" title="Colone 'Rangée'">
							Rangée
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnPositionChoice"
							id="summaryColumnPositionChoice"
						...
						/>
						<label
							htmlFor="summaryColumnPositionChoice"
							title="Colone 'Position'"
						>
							Position
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnTypeChoice"
							id="summaryColumnTypeChoice"
							checked={switchboard.summaryColumnType}
							onChange={(e) =>
								setSwitchboard((old) => ({
									...old,
						...
						/>
						<label htmlFor="summaryColumnTypeChoice" title="Colone 'Type'">
							Type
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnIdChoice"
							id="summaryColumnIdChoice"
							checked={switchboard.summaryColumnId}
							onChange={(e) =>
								setSwitchboard((old) => ({
									...old,
						...
						/>
						<label htmlFor="summaryColumnIdChoice" title="Colone 'Identifiant'">
							Identifiant
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnFunctionChoice"
							id="summaryColumnFunctionChoice"
						...
						/>
						<label
							htmlFor="summaryColumnFunctionChoice"
							title="Colone 'Fonction'"
						>
							Fonction
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnLabelChoice"
							id="summaryColumnLabelChoice"
							checked={switchboard.summaryColumnLabel}
							onChange={(e) =>
								setSwitchboard((old) => ({
									...old,
						...
						/>
						<label htmlFor="summaryColumnLabelChoice" title="Colone 'Libellé'">
							Libellé
						</label>
					</div>
					<div className="tabPageBandCol">
						<input
							type="checkbox"
							name="summaryColumnDescriptionChoice"
						...
						/>
						<label
							htmlFor="summaryColumnDescriptionChoice"
							title="Colone 'Annotations'"
						>
							Annotations
						</label>
					</div>
				...
				<thead>
					<tr>
						...
						{switchboard.summaryColumnId && (
							<th style={{ width: "100px", paddingRight: "1em" }}>
								Identifiant
							</th>
						)}
								...
								if (!module.free) {
									const ret = (
										...
										>
												...
												<td className="summary_position">
													<div>
														<img
															...
															alt="Position"
														/>
														<span>P{`${j + 1}`.padStart(2, "0")}</span>
													</div>
												</td>
											)}
											{switchboard.summaryColumnType && (
												<td
													className="summary_type"
													onClick={() => handleEdit(module, "main", "icon")}
											...
											{switchboard.summaryColumnId && (
												<td
													className="summary_id"
													onClick={() => handleEdit(module, "main", "id")}
													title={"Cliquer pour éditer"}
												>
													<div>{module.id}</div>
												</td>
											...
											{switchboard.summaryColumnFunction && (
												<td
													className="summary_func"
													onClick={() => handleEdit(module, "schema")}
													title={"Cliquer pour éditer"}
												>
													{schemaFunctions[module.func] && (
														<p>
															{schemaFunctions[module.func]?.name ?? ""}
															<br />
															{schemaFunctions[module.func]?.hasType === true &&
																`Type ${module.type} `}
															{schemaFunctions[module.func]?.hasCrb === true &&
																`Courbe ${module.crb} `}
															{schemaFunctions[module.func]?.hasType === true &&
																`${module.sensibility} `}
											...
											{switchboard.summaryColumnLabel && (
												<td
													...
													onClick={() => handleEdit(module, "main", "text")}
													title={"Cliquer pour éditer"}
												>
													<div>{module.text}</div>
												</td>
											...
											{switchboard.summaryColumnDescription && (
												<td
													className="summary_text"
													onClick={() => handleEdit(module, "main", "desc")}
													title={"Cliquer pour éditer"}
												>
													<div>{module.desc}</div>
												</td>
