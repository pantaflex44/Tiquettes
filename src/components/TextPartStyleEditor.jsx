...
export default function TextPartStyleEditor({
	...
	return !positions[propName].shown ? (
		<span className={"tep-settings_hidden"}>Masqué</span>
	) : (
		<>
			<div className={"tep-settings_row"}>
				<label htmlFor={"tep-id-fullheight"}>
					Utiliser toute la hauteur disponible:
				</label>
				<input
					type={"checkbox"}
					checked={editedTheme.data[propName]?.fullHeight ?? false}
			...
			<div className={"tep-settings_row"}>
				...
				<input
					type={"number"}
					value={editedTheme.data[propName]?.lineCount ?? 1}
					min={1}
					max={5}
					step={1}
					id={"tep-id-lineCount"}
			...
			<div className={"tep-settings_row"}>
				<div className={"tep-settings_row-el"}>
					...
					<input
						type={"checkbox"}
						checked={
							(editedTheme.data[propName]?.horizontalAlignment ?? "center") ===
							"left"
						}
						...
						onChange={(e) =>
							setEditedTheme((old) => ({
								...
								data: {
									...
									[propName]: {
										...(old.data[propName] ?? {}),
										horizontalAlignment: e.target.checked
											? "left"
											: old.data[propName]?.horizontalAlignment,
									},
								},
							}))
						}
			...
			<div className={"tep-settings_row"}>
				...
				<input
					type={"number"}
					value={(editedTheme.data[propName]?.fontSize ?? "2.4mm").replaceAll(
						"mm",
						"",
					)}
					min={2.0}
			...
			<div className={"tep-settings_row"}>
				<div className={"tep-settings_row-el"}>
					...
					/>
					<GroupColorChooser
						value={editedTheme.data[propName]?.backgroundColor ?? "#ffffff"}
						...
						useGroupColorValue={
							editedTheme.data[propName]?.bgcolorUseGrp === true
						}
						onUseGroupColorChange={(e) =>
							setEditedTheme((old) => ({
								...
								data: {
									...
									[propName]: {
										...(old.data[propName] ?? {}),
										bgcolorUseGrp: e.target.checked,
									},
								},
							}))
						}
				...
				<div className={"tep-settings_row-el"}>
					...
					/>
					<GroupColorChooser
						value={editedTheme.data[propName]?.color ?? "#000000"}
						id={"tep-id-color"}
						name={"tep-id-color"}
						onChange={(c) =>
							setEditedTheme((old) => ({
						...
						useGroupColorValue={
							editedTheme.data[propName]?.fgcolorUseGrp === true
						}
						onUseGroupColorChange={(e) =>
							setEditedTheme((old) => ({
								...old,
								data: {
									...
									[propName]: {
										...(old.data[propName] ?? {}),
										fgcolorUseGrp: e.target.checked,
									},
								},
							}))
						}
				...
				<div className={"tep-settings_row-el"}>
					...
					<input
						type={"checkbox"}
						checked={
							(editedTheme.data[propName]?.fontWeight ?? "normal") === "bold"
						}
				...
				<div className={"tep-settings_row-el"}>
					...
					<input
						type={"checkbox"}
						checked={
							(editedTheme.data[propName]?.fontStyle ?? "normal") === "italic"
						}
						id={"tep-id-fontStyle"}
