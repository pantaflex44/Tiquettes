...
export default function Editor({
    ...
    const getParentById = (parentId) => {
        const parent = Object.entries(getFilteredModulesBySchemaFuncs())
            .map(([k, l]) => {
                const res = l.map((module) => (parentId === module.id ? module : null)).filter((f) => f !== null);
                            ...
                            <>
                                <div className="popup_row" style={{ "--left_column_size": "100px" }}>
                                    ...
                                    <div className="popup_row-flex">
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                onUpdateModuleEditor({ noAutoId: !ed.currentModule.noAutoId })
                                            }
                                            style={{
                                                backgroundColor:
                                                    ed.currentModule.noAutoId !== true
                                        ...
                                        >
                                            <img
                                                src={
                                                    ed.currentModule.noAutoId === true ? numberManIcon : numberAutoIcon
                                                }
                                                width={22}
                                                height={22}
                                                style={{
                                                    filter: ed.currentModule.noAutoId !== true ? "invert()" : "initial",
                                                }}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            Regrouppez vos circuits en utilisant des couleurs personnalisées.
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <IconSelector
                                            ...
                                            onChange={(selectedIcon, selected) => {
                                                if (
                                                    ...
                                                    if (selected?.current && ed.currentModule.current === "")
                                                        onUpdateModuleEditor({ current: selected?.current });
                                                    ...
                                                    if (selected?.modtype && !isCustomFunction)
                                                        onUpdateModuleEditor({ modtype: selected?.modtype });
                                                }
                                ...
                                <div className="popup_row" style={{ "--left_column_size": "100px" }}>
                                    <label htmlFor={`editor_desc_${ed.currentModule.id.trim()}`}>
                                        Annotations
                                        <br />
                                        <span style={{ fontSize: "0.8em", color: "gray" }}>(nomenclature)</span>
                                    </label>
                                    <textarea
                                        name="editor_desc"
