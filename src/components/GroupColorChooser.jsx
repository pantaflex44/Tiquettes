		...
		<>
			...
			{opened && (
				...
				>
					...
					{typeof useGroupColorValue === "boolean" && onUseGroupColorChange && (
						<div className={"gcc-box_group"}>
							<input
								id={`use_grp_${id}`}
								name={`use_grp_${id}`}
								type="checkbox"
								checked={useGroupColorValue}
								onChange={onUseGroupColorChange}
								disabled={disabled}
							/>
							<label htmlFor={`use_grp_${id}`}>
								Utiliser la couleur du groupe si elle est définie dans les
