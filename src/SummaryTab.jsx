                ...
                <div className="tabPageBandGroup">
                    ...
                    <div className="tabPageBandCol">
                        <input type="checkbox" name="summaryColumnPositionChoice" id="summaryColumnPositionChoice"
                               checked={switchboard.summaryColumnPosition} onChange={(e) => setSwitchboard((old) => ({
                            ...old,
                    ...
                    <div className="tabPageBandCol">
                        <input type="checkbox" name="summaryColumnFunctionChoice" id="summaryColumnFunctionChoice"
                               checked={switchboard.summaryColumnFunction} onChange={(e) => setSwitchboard((old) => ({
                            ...old,
                    ...
                    <div className="tabPageBandCol">
                        <input type="checkbox" name="summaryColumnDescriptionChoice" id="summaryColumnDescriptionChoice"
