...
export default function Main() {
    ...
    const imagesPreloader = () => {
        return [
            'schema_1P+N', 'schema_2P', 'schema_3P', 'schema_3P+N', 'schema_4P', 'schema_blank', 'schema_bpnf', 'schema_bpno', 'schema_c', 'schema_cc', 'schema_cnf', 'schema_cno', 'schema_cpt', 'schema_dd', 'schema_fus', 'schema_i', 'schema_id', 'schema_k', 'schema_k_nc', 'schema_kc', 'schema_led', 'schema_o', 'schema_pc', 'schema_prd', 'schema_q', 'schema_son', 'schema_sw', 'schema_telec', 'schema_trf', 'schema_warning',
            'swb_alim', 'swb_alim_eco', 'swb_alim_ht', 'swb_battery', 'swb_bec', 'swb_bell', 'swb_blank', 'swb_blrgas', 'swb_calendar-clock', 'swb_chauffage', 'swb_clim', 'swb_clock', 'swb_coffeetea', 'swb_contact', 'swb_cuissin', 'swb_differential-circuit-breaker', 'swb_dryer', 'swb_eau', 'swb_ecl', 'swb_ecl_cmd', 'swb_ecl_rgb', 'swb_ecl2', 'swb_eclext', 'swb_electric-motor', 'swb_ermt', 'swb_ext', 'swb_fire', 'swb_fountain', 'swb_four', 'swb_frigo', 'swb_froid', 'swb_garage', 'swb_gaz', 'swb_grid', 'swb_ground', 'swb_home', 'swb_homeshield', 'swb_iceberg', 'swb_induction', 'swb_informatique', 'swb_inverter', 'swb_ironing', 'swb_journuit', 'swb_lg', 'swb_ll', 'swb_lv', 'swb_microonde', 'swb_minuterie', 'swb_music', 'swb_pc', 'swb_pc_kitchen', 'swb_pc2', 'swb_pctri', 'swb_pompe1', 'swb_pool', 'swb_portail', 'swb_puissance', 'swb_remswitch', 'swb_ship', 'swb_smoke', 'swb_solaire', 'swb_solchauffant', 'swb_soup', 'swb_spa', 'swb_split', 'swb_store', 'swb_surgeprotector', 'swb_telec', 'swb_telephonie', 'swb_thermo', 'swb_thermo2', 'swb_thermo3', 'swb_thermo4', 'swb_transformer', 'swb_tv', 'swb_twldryer', 'swb_ventil', 'swb_ventil2', 'swb_vmc', 'swb_voitureelectrique', 'swb_voitureelectrique2', 'swb_volet',
