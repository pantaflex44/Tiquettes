...
const oldpkg = require("./package.json");

let version = "1.0.0";
const versions = Object.keys(appConfig.changelog ?? {});
if (versions.length > 0) version = versions[0];
const versionDate = appConfig.changelog[version]?.date ?? "";
