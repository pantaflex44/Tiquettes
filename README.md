...
<a href="https://www.tiquettes.fr/dons.php" style="text-decoration: none; background: black; color: white; padding-inline: 1.5rem; padding-block: 1rem; font-size: 0.9rem; font-weight: 600; margin: 0;">Soutenir l'application en faisant un don <span style="color: red; margin-left: 0.5rem; font-size: 1.1rem;">♥</span></a>
<br /><br />
...
<img alt="Projets" src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fwww.tiquettes.fr%2Fapp%2Fapi%2Fstats_read.php%3Fm%3Dproduction&query=%24.actions.totals.create&label=Projets&color=%23008b8b">&nbsp;&nbsp;
<img alt="Impressions" src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fwww.tiquettes.fr%2Fapp%2Fapi%2Fstats_read.php%3Fm%3Dproduction&query=%24.actions.totals.print&label=Impressions&color=%23008b8b">&nbsp;&nbsp;
